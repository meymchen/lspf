---
title: Build an LSP client
description: Connect to a language server over a custom transport or supervised stdio child.
---
...
[`public_conformance.rs`](https://github.com/meymchen/lspf/blob/main/crates/lspf/tests/public_conformance.rs) also
