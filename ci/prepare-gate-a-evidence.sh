      ...
      {name: $name, description: $description, run: $run};
    {
      ...
      claims: [
        ...
        },
        {
          ...
          classification: "automated",
          sources: [source("crates/lspf/Cargo.toml"), source("website/src/content/docs/en/tutorials/server.md"), source("website/src/content/docs/en/tutorials/client.md"), source("ci/check-package-file-policy.sh"), source("ci/check-packaged-crate.sh"), source("ci/check-tutorials.sh"), source(".github/workflows/packaged-crate.yml")],
