...
- Encapsulate notebook synchronization and add debug examples ([#322](https://github.com/meymchen/lspf/pull/322))
- Move the starter template out of tree ([#318](https://github.com/meymchen/lspf/pull/318))

### Other

- Present lspf as IDE and agent infrastructure ([#321](https://github.com/meymchen/lspf/pull/321))
- *(website)* Migrate to VitePress at lspf.dev ([#320](https://github.com/meymchen/lspf/pull/320))
