...
fn options() -> SemanticTokensOptions {
    SemanticTokensOptions {
        ...
        legend: SemanticTokensLegend {
            token_types: vec![
                SemanticTokenType::Keyword.to_string(),
                SemanticTokenType::Variable.to_string(),
                SemanticTokenType::Function.to_string(),
                SemanticTokenType::Operator.to_string(),
                SemanticTokenType::Parameter.to_string(),
                SemanticTokenType::Type.to_string(),
            ],
            token_modifiers: vec![SemanticTokenModifier::Definition.to_string()],
        },
        range: None,
        full: None,
    }
