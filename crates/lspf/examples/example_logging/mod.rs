...
///
/// Logs go to stderr on every example: the stdio ones carry the LSP wire
/// protocol on stdout, and a socket example is observed through stderr by a
/// client that did not spawn it.
pub(crate) fn init() {
